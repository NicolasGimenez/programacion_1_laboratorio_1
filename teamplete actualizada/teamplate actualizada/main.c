...
int main()
{
    ...
    do
    {
        getValidInt("\n\n1.Alta\n2.Baja\n3.Modificar\n4.Mostrar\n5.Ordenar\n6.Mostrar Debug\n7.Contratar\n9.Salir\n10.lista pantalla ordenada (precio-nombre)\n11.pantallas con valor <=1000\n12.lista de pantalla supera el promedio de precio\n13.lista pantalla con mas de una publicacion\n","\nNo valida\n",&menu,1,15,1);
        switch(menu)
        {
            case 1:
            ...
            case 11:
                ...
                break;
            case 12:
                promedio_precio_pantalla(array,QTY);
                break;
            case 13:
                listar_pantalla_mas_1_publicacion(contrataciones,LEN_CONT,array,QTY);
