...
int listar_pantalla_mas_1_publicacion(Contratacion* arrayC,int limiteC,Pantalla* arrayP,int limiteP)
{
    ...
    if(limiteP > 0 && limiteC > 0 && arrayP!= NULL && arrayC!= NULL)
    {
        for(i=0;i<limiteP;i++)
        {
            ...
            {
                retorno=0;
                printf("\nContrataciones %d -nombre %s -id %d\n",contadorPublicaciones,arrayP[i].nombre,arrayP[i].idPantalla);
            }
    ...
    if(limiteC > 0 && arrayC != NULL && limiteP > 0 && arrayP != NULL)
    {
        for(i=0;i<limiteP;i++)
        {
            ...
            for(j=0;j<limiteC;j++)
            {
                ...
                {
                    retorno = 0;
                    printf("\nContrataciones %d -nombre %s -id %d\n",publicaciones,arrayP[i].nombre,arrayP[i].idPantalla);
                }
            }
